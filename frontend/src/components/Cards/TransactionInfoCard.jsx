    ...
    <div className='group relative flex items-center gap-4 mt-2 p-3 rounded-lg hover:bg-gray-100/60'>
      ...
      <div className='flex-1 flex item-centre justify-between'>
        ...
        <div className='flex flex-col items-end gap-2 md:flex-row md:items-center'>
          {!hideDeleteBtn && (
            <button
              className='text-gray-400 hover:text-red-500 transition-opacity cursor-pointer opacity-100 md:opacity-0 md:group-hover:opacity-100 w-9 h-9 flex items-center justify-center mb-1 md:mb-0'
              onClick={onDelete}
